...
public class Samir <T extends Comparable<T>> implements HashTable<T>{
    private int size;
    private List<T>[][] outerTable;
...
//            }
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (counter[i] == 0) { //No inner Table
//                System.out.println("NO INNER TABLE ...BUILDING TABLE AT ["+i+"]");
