...
public class Main {
    ...
    public static void main(String[] args) {
        UniversalHashing<String> u = new UniversalHashing<>(new String[]{"apple", "banana", "orange", "grape", "watermelon", "melon", "pineapple", "strawberry", "blueberry", "raspberry"});
//        System.out.println(u.contains("lol"));
        u.print();
    }
//    public static void main(String[] args) {
